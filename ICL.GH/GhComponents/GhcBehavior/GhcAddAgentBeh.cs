    ...
    public class GhcAddAgentBeh : GH_Component
    {
        ...
        public GhcAddAgentBeh()
          : base(
              ...
              "Define the system's add column behaviour",
              "ABxM",
              "ICL")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Angle", "A", "Minimum angle between mesh edges", GH_ParamAccess.item, 20.0);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            double iAngle = double.NaN;
            DA.GetData(3, ref iAngle);

            if (behavior == null)
                behavior = new AddAgentBehavior(iWeight, iDisplacement, iProbability, iAngle);
            else
            {
                behavior.Weight = iWeight;
                behavior.Displacement = iDisplacement;
                behavior.Probability = iProbability;
                behavior.AngleThreshold = iAngle;
            }
